export const metadata = {
  title: "Mastering AI System Design: Lessons from Open Claude Architecture — ByteWise",
  description: "Learn how modern AI systems work through Open Claude architecture. A practical guide to event-driven design, agents, tools, and automation.",
  keywords: ["AI system design", "event-driven architecture AI", "AI agents architecture", "Open Claude AI guide", "multi-agent systems"],
  openGraph: {
    title: "Mastering AI System Design: Lessons from Open Claude Architecture",
    description: "Learn how modern AI systems work through Open Claude architecture. A practical guide to event-driven design, agents, tools, and automation.",
    type: "article",
  },
};

# Mastering AI System Design: Lessons from Open Claude Architecture
