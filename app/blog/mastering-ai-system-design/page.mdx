export const metadata = {
  title: "Mastering AI System Design: Lessons from Open Claw Architecture — ByteWise",
  description: "Learn how modern AI systems work through Open Claw architecture. A practical guide to event-driven design, agents, tools, and automation.",
  keywords: ["AI system design", "event-driven architecture AI", "AI agents architecture", "Open Claw AI guide", "multi-agent systems"],
  openGraph: {
