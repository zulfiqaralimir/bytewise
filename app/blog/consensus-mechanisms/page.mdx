export const metadata = {
  title: "Consensus Mechanisms: Proof of Work vs Proof of Stake Explained from First Principles — ByteWise",
  description: "How do thousands of computers agree on a single truth without trusting each other? A first-principles breakdown of Proof of Work, Proof of Stake, slashing, The Merge, and PBFT.",
  keywords: ["consensus mechanism", "proof of work", "proof of stake", "blockchain", "Bitcoin", "Ethereum", "mining", "staking", "slashing", "the merge", "Byzantine Generals", "PBFT"],
  openGraph: {
...
*Day 2 of the Blockchain Developer Learning Track — Black Iron Quantum AI*  
*Previous: What Is Blockchain? Blocks, Hashing, and Chain Structure*  
*Next: Wallets, Addresses, and Keys — Public Key Cryptography Explained from First Principles*
