...
const trackB: PartEntry[] = [
  ...
  },
  {
    ...
    modules: [
      { number: "Module 73", title: "Portfolio Construction & Optimization", description: "Markowitz to Black-Litterman — efficient frontier, risk parity, risk budgeting, factor exposure management, and rebalancing.", href: "/financial-strategy/module-73-portfolio-construction" },
  ...
  },
  {
    ...
    modules: [
      ...
      { number: "Module 82", title: "Commodity Markets & Trading",             description: "Commodity markets structure, futures curves, roll yield, weather derivatives, and commodity trading strategies.", href: null },
      { number: "Module 83", title: "Global Macro Trading",                    description: "FX carry, rates macro, equity macro, commodity macro — how discretionary and systematic macro funds build and express views.", href: null },
      { number: "Module 84", title: "Quantitative Risk Models: EVT & Copulas", description: "Extreme value theory, copula-based dependence modeling, and advanced portfolio risk aggregation.", href: null },
      { number: "Module 85", title: "Portfolio Risk Reporting",                description: "Risk reporting infrastructure, P&L attribution, risk decomposition, regulatory reporting, and board-level risk communication.", href: null },
      { number: "Module 86", title: "Alternative Data Sourcing & Signals",     description: "Alternative data taxonomy, sourcing, cleaning, signal construction, and legal/compliance considerations.", href: null },
      { number: "Module 87", title: "Systematic Strategy Implementation",      description: "From signal to trade — execution, position sizing, portfolio construction, live monitoring, and strategy decay.", href: null },
      { number: "Module 88", title: "Fund Legal Structures",                   description: "Cayman limited partnership, BVI, DIFC fund structures, Pakistan NBFC structures, governing documents, side pockets.", href: null },
      { number: "Module 89", title: "Tax for Investment Managers",             description: "Fund-level and investor-level taxation, carried interest tax treatment, UAE/Cayman tax neutrality, Pakistan tax for NRPs.", href: null },
      { number: "Module 90", title: "ESG for Investment Managers",             description: "ESG integration in quant strategies, factor-based ESG, greenwashing risk, SFDR classification, Gulf SWF ESG mandates.", href: null },
