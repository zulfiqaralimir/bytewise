...
**Step 1:** You <UserConcept href="/docs/cs-book/part-8-blockchain/blockchain-glossary#broadcast-to-the-network">broadcast</UserConcept> your transaction to the network. "I want to send 1 ETH to this address."
...
**Step 4:** The first miner to find a valid nonce <UserConcept href="/docs/cs-book/part-8-blockchain/blockchain-glossary#broadcast-to-the-network">broadcasts</UserConcept> their completed block to the network.
