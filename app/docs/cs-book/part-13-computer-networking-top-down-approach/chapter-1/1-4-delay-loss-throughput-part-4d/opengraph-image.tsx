  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Queueing Delay, Traffic Intensity &amp; Congestion
        </div>
        ...
        >
          Buffer Overflow · Packet Loss · Congestion Control
        </div>
        ...
        >
          {["Traffic Intensity", "Buffer Overflow", "Packet Loss", "Congestion"].map((tag) => (
            <div
              key={tag}
              style={{
                padding: "6px 18px",
