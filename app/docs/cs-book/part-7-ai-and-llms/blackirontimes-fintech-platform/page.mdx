export const metadata = {
  title: "Case Study: Engineering a Scalable Bloomberg-Style Fintech Platform — ByteWise CS Book",
  ...
  keywords: ["fintech platform", "Next.js ISR", "Supabase", "Cloudflare R2", "system design case study", "scalable architecture", "Bloomberg Terminal"],
  openGraph: {
    title: "Case Study: Engineering a Scalable Bloomberg-Style Fintech Platform — ByteWise CS Book",
...
This is the most consequential architectural decision in the platform — and it maps directly to the caching concepts covered in [Part 3 — Caching](/docs/cs-book/part-3-system-design/caching).
...
The planned AI pipeline builds on the agentic patterns covered in [Agentic AI](/docs/cs-book/part-7-ai-and-llms/agentic-ai).
...
<ArticleNav
  prev={{
    title: "OpenClaw: Production-Ready Architecture",
    href: "/docs/cs-book/part-7-ai-and-llms/openclaw-production-design",
  }}
  next={{
