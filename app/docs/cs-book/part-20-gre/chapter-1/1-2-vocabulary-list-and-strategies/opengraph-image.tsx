  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          GregMat Vocabulary List · Spaced Repetition · Active Recall · Root Patterns
        </div>
        ...
        >
          {["Vocabulary List", "Spaced Repetition", "Active Recall", "GregMat"].map((tag) => (
            <div
              key={tag}
              style={{
                padding: "6px 18px",
