  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Main Idea · Inference · Structure · Detail · Vocabulary-in-Context
        </div>
        ...
        >
          {["Five Content Types", "Three Answer Formats", "Select in Passage", "Worked Examples"].map((tag) => (
            <div
              key={tag}
              style={{
                padding: "6px 18px",
