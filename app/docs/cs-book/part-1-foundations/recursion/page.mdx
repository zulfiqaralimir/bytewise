...
<ArticleNav
  prev={{ href: "/docs/cs-book/part-1-foundations/hash-tables", title: "Hash Tables" }}
  next={{ href: "/docs/cs-book/part-2-design-patterns/chapter-1/0-what-problem-does-lld-solve", title: "Section 0: What Problem Is LLD Even Solving?" }}
/>
