...
|---|---------|------------|---------|
| 1 | [Two Sum](https://leetcode.com/problems/two-sum/) | 🟢 Easy | Classic hash map lookup — the "hello world" of hash table problems |
| 217 | [Contains Duplicate](https://leetcode.com/problems/contains-duplicate/) | 🟢 Easy | Set membership check in O(n) |
| 242 | [Valid Anagram](https://leetcode.com/problems/valid-anagram/) | 🟢 Easy | Frequency counting with a hash map |
| 49 | [Group Anagrams](https://leetcode.com/problems/group-anagrams/) | 🟡 Medium | Using sorted string as a hash key |
| 347 | [Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/) | 🟡 Medium | Frequency map + heap or bucket sort |
| 128 | [Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/) | 🟡 Medium | O(n) via hash set — the key insight is skipping non-starts |
| 560 | [Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) | 🟡 Medium | Prefix sum stored in a hash map |
| 146 | [LRU Cache](https://leetcode.com/problems/lru-cache/) | 🔴 Hard | Hash map + doubly linked list — the canonical O(1) cache design |
