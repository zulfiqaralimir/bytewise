    ...
    chapters: [
      {
        ...
        items: [
          ...
          { title: "1.5 SAM Multiplier Analysis: Data to Policy Insights", href: "/docs/cs-book/part-11-economic-finance-models/chapter-1/1-5-pakistan-sam-multiplier-analysis" },
        ],
      },
      {
