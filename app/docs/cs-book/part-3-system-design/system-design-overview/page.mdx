...
**Reference:** [roadmap.sh/system-design](https://roadmap.sh/system-design)
...
<ArticleNav
  prev={{ href: "/docs/cs-book/part-3-system-design/system-design-fundamentals", label: "System Design Fundamentals" }}
  next={{ href: "/docs/cs-book/part-3-system-design/system-design-interview-framework", label: "10-Step Interview Framework" }}
/>
