export const metadata = {
  title: "System Design Overview (HLD & LLD) — ByteWise CS Book",
  description:
  ...
  openGraph: {
    title: "System Design Overview (HLD & LLD) — ByteWise CS Book",
    description:
      "Learn system design end-to-end: architecture decisions, scalability patterns, HLD vs LLD, and how to design systems like Netflix, WhatsApp, and Uber.",
  },
};

import { ArticleNav } from "@/app/components/ArticleNav";

# System Design Overview (HLD & LLD)
