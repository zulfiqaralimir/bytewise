...
| Access specifiers (compiler-enforced) | `private:` / `protected:` / `public:` | [Section 2](/docs/cs-book/part-2-design-patterns/chapter-1/2-encapsulation), [Section 4](/docs/cs-book/part-2-design-patterns/chapter-1/4-inheritance) |
