  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Data Parsing · Leontief Multipliers · Policy Shocks · Pakistan 2013-19
        </div>
        ...
        >
          {["Type I & II Multipliers", "Pyatt-Round Partition", "5 Policy Scenarios", "Interactive Dashboard"].map((tag) => (
            <div
              key={tag}
              style={{
                padding: "8px 20px",
