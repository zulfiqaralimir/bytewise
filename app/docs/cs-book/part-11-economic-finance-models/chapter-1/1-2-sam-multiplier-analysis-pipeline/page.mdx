export const metadata = {
  title: "1.2 Building a Production-Grade SAM Multiplier Analysis Pipeline — ByteWise CS Book",
...
> **Simple takeaway:** A SAM multiplier pipeline turns a static 179×179 accounting matrix into a policy simulator — every rupee of stimulus you trace through the Leontief inverse tells you not just how much output grows, but which sectors and households actually feel it.
...
<ArticleNav
  ...
  next={{ title: "1.3 SAM Multiplier Analysis: Data to Policy Insights", href: "/docs/cs-book/part-11-economic-finance-models/chapter-1/1-3-pakistan-sam-multiplier-analysis" }}
/>
