export const metadata = {
  title: "1.1 How to Read a Social Accounting Matrix — ByteWise CS Book",
  ...
  openGraph: {
    title: "1.1 How to Read a Social Accounting Matrix (SAM)",
...
<ArticleNav
  prev={{ title: "Social Accounting Matrix: A Complete Guide", href: "/docs/cs-book/part-11-economic-finance-models/chapter-1/social-accounting-matrix" }}
  next={{ title: "1.2 SAM Multiplier Analysis Pipeline", href: "/docs/cs-book/part-11-economic-finance-models/chapter-1/1-2-sam-multiplier-analysis-pipeline" }}
/>
