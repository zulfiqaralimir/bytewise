export const metadata = {
  title: "1.3 Pakistan SAM Multiplier Analysis: From Data to Policy Insights — ByteWise CS Book",
...
<ArticleNav
  prev={{ title: "1.2 SAM Multiplier Analysis Pipeline", href: "/docs/cs-book/part-11-economic-finance-models/chapter-1/1-2-sam-multiplier-analysis-pipeline" }}
  next={{ title: "1.4 Types of Equations in SAM & CGE Modeling", href: "/docs/cs-book/part-11-economic-finance-models/chapter-1/1-4-types-of-equations-sam-cge-modeling" }}
/>
